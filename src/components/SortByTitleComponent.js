...
if (!Array.isArray(users)) {
  ...
  return (
    <div>
        <button className="button" onClick={()=>setSortType('asc')}>Sort By Title in Ascending</button>
        <button className="button" onClick={()=>setSortType('desc')}>Sort By Title in Descending </button>
